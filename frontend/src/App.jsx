      ...
      <Routes>
        ...
        <Route path="/*" element={<MainLayout />}>
          ...
          <Route path="community" element={<CommunityPage />}>
            {/* /community로 접근 시 자동으로 /community/free로 리디렉션 */}
            <Route index element={<Navigate to="free" replace />} />
            <Route path=":category" element={<PostList />} />
          </Route>

          {/* 게시글 상세 경로는 post/:postId 사용 */}
          <Route path="post/:postId" element={<PostDetail />} />

          {/* 게시글 작성/수정 경로는 카테고리 유지를 위해 community/{action}/{category} 구조 사용 */}
        ...
        {/* MainLayout을 사용하지 않는 독립적인 인증 관련 페이지들 */}
