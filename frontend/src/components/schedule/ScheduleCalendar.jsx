...
function ScheduleCalendar({ 
    ...
    // 날짜 포맷팅 유틸리티 함수들 (코드가 없으므로 임의 구현)
                ...
                return (
                    <div className="schedule-indicator" style={{ textAlign: 'center', marginTop: '3px' }}>
                         <div style={{ 
                             height: '6px', 
                             width: '6px', 
                             backgroundColor: daySchedules[0].isBookmarked ? '#4c51bf' : '#dc2626', // Tailwind 색상으로 변경
                             borderRadius: '50%',
                             margin: '3px auto'
                         }} />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="calendar-section bg-gray-50 p-4 rounded-lg shadow-xl">
                    <Calendar 
                        ...
                        // ⭐ activeStartDate prop을 currentViewDate로 전달
